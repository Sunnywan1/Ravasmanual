package Default.German.German_xPicoWifi;
...
public class SelectNetworkGermanWifiView extends GridPane {
    ...
    public SelectNetworkGermanWifiView (FlowPane mainpane) {

        txtTutorial = new Text("This is German xPicoWifi");
